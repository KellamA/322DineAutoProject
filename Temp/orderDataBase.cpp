...
OrderDatabase::OrderDatabase(const std::string& fileName) {

    this->fileName = fileName;
    std::cout << "Using file path: " << fileName << std::endl;
}
...
std::string OrderDatabase::getFileName() const
{
    return this->fileName;
}
void OrderDatabase::setFileName(const std::string newFileName)
{
