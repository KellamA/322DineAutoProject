...
constexpr auto qt_meta_stringdata_CLASSCartDialogENDCLASS = QtMocHelpers::stringData(
    "CartDialog",
    "populateCart",
    "",
...
void CartDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->populateCart(); break;
        case 1: _t->onRemoveItemButtonClicked(); break;
